...
#include "utils/SnippetVehicleFilterShader.h"
									...
									PxPhysics& physics)
{
	...
	unsigned wheelLayer = LayerMask::nameToLayer("Wheels");
	unsigned wheelLayerId = LayerMask::nameToLayerInt("Wheels");

	//Wheel and chassis simulation filter data.
	PxFilterData wheelSimFilterData;
	wheelSimFilterData.word0 = wheelLayer; // COLLISION_FLAG_WHEEL;
	wheelSimFilterData.word1 = wheelLayerId;// COLLISION_FLAG_WHEEL_AGAINST;
	wheelSimFilterData.word2 = true;

	unsigned chassisLayer = LayerMask::nameToLayer("Chassis");
	unsigned chassisLayerId = LayerMask::nameToLayerInt("Chassis");

	PxFilterData chassisSimFilterData;
	chassisSimFilterData.word0 = chassisLayer; //COLLISION_FLAG_CHASSIS;
	chassisSimFilterData.word1 = chassisLayerId; //COLLISION_FLAG_CHASSIS_AGAINST;
	chassisSimFilterData.word2 = true;

...
#define KERNEL_ENDIAN_LITTLE 1
#define KERNEL_ENDIAN_BIG 2

//Windows
#define KERNEL_ENDIAN KERNEL_ENDIAN_LITTLE

typedef unsigned RGBA;
typedef unsigned ARGB;
typedef unsigned ABGR;
typedef unsigned BGRA;

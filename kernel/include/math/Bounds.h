...
public:
    ...
    */
    ...
    inline Bounds() : mMinimum(Vector3::ZERO), mMaximum(Vector3::UNIT_SCALE), mCorners(0)
    {
    ...
    inline Bounds(Extent e) : mMinimum(Vector3::ZERO), mMaximum(Vector3::UNIT_SCALE), mCorners(0)
    {
        setMinimum( -0.5, -0.5, -0.5 );
        setMaximum( 0.5, 0.5, 0.5 );
        mExtent = e;
    ...
    inline Bounds(const Bounds & rkBox) : mMinimum(Vector3::ZERO), mMaximum(Vector3::UNIT_SCALE), mCorners(0)
    ...
    inline Bounds( const Vector3& min, const Vector3& max ) : mMinimum(Vector3::ZERO), mMaximum(Vector3::UNIT_SCALE), mCorners(0)
    {
        setExtents( min, max );
    }
    ...
    {
        if (mCorners)
            OGRE_FREE(mCorners, Ogre::MEMCATEGORY_SCENE_CONTROL);
    }
    ...
    */
    inline const Vector3* getAllCorners(void) const
    {
        ...
        if (!mCorners)
            mCorners = OGRE_ALLOC_T(Vector3, 8, Ogre::MEMCATEGORY_SCENE_CONTROL);
    ...
    */
    ...
    KERNEL_VS_EXPORT friend std::ostream& operator<<( std::ostream& o, const Bounds &aab )
    {
        switch (aab.mExtent)
        {
        case EXTENT_NULL:
    ...
    */
    ...
    // special values
    static const Bounds BOX_NULL;
    static const Bounds BOX_INFINITE;
